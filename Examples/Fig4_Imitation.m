...
sgtitle('Figure 4 a = 3 (Initial Pop: [3, 6, 12]): per\_cd vs per\_ddc vs soft\_majo');
...
subplot(1,2,2);
plot(POP_sim, 'LineWidth', 2); title('Simulation'); legend(Strategies); grid on;
sgtitle('Figure 4 a = 3.4 (Initial Pop: [3, 6, 12]): per\_cd vs per\_ddc vs soft\_majo');
...
subplot(1,2,2);
plot(POP_sim, 'LineWidth', 2); title('Simulation'); legend(Strategies); grid on;
sgtitle('Figure 4 a = 3.8 (Initial Pop: [3, 6, 12]): per\_cd vs per\_ddc vs soft\_majo');